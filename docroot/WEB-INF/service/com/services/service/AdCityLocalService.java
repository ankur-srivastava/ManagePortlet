...
/**
 * Provides the local service interface for AdCity. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ankur Srivastava
 * @see AdCityLocalServiceUtil
...
public interface AdCityLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AdCityLocalServiceUtil} to access the ad city local service. Add custom service methods to {@link com.services.service.impl.AdCityLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
