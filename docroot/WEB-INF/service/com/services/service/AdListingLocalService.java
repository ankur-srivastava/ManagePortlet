...
/**
 * Provides the local service interface for AdListing. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ankur Srivastava
 * @see AdListingLocalServiceUtil
...
public interface AdListingLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AdListingLocalServiceUtil} to access the ad listing local service. Add custom service methods to {@link com.services.service.impl.AdListingLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
