...
import com.services.service.AdCityLocalService;
...
/**
 * Provides the base implementation for the ad city local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.services.service.impl.AdCityLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class AdCityLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements AdCityLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.services.service.AdCityLocalServiceUtil} to access the ad city local service.
	 */
	...
	@Override
	public AdCity addAdCity(AdCity adCity) throws SystemException {
		adCity.setNew(true);

		return adCityPersistence.update(adCity);
	}
	 ...
	 */
	@Override
	public AdCity createAdCity(long cityId) {
		return adCityPersistence.create(cityId);
	}
	...
	@Override
	public AdCity deleteAdCity(long cityId)
		throws PortalException, SystemException {
		return adCityPersistence.remove(cityId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public AdCity deleteAdCity(AdCity adCity) throws SystemException {
		return adCityPersistence.remove(adCity);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AdCity.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return adCityPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return adCityPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return adCityPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return adCityPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public AdCity fetchAdCity(long cityId) throws SystemException {
		return adCityPersistence.fetchByPrimaryKey(cityId);
	}
	 ...
	 */
	@Override
	public AdCity getAdCity(long cityId)
		throws PortalException, SystemException {
		return adCityPersistence.findByPrimaryKey(cityId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return adCityPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AdCity> getAdCities(int start, int end)
		throws SystemException {
		return adCityPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getAdCitiesCount() throws SystemException {
		return adCityPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AdCity updateAdCity(AdCity adCity) throws SystemException {
		return adCityPersistence.update(adCity);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.services.model.AdCity",
			adCityLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.services.model.AdCity");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = adCityPersistence.getDataSource();
	...
	private AdCityLocalServiceClpInvoker _clpInvoker = new AdCityLocalServiceClpInvoker();
}